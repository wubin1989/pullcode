  ...
  */
  postPetParamsPetId(
    params: {
      ...
      return this.getAxios().post(`/pet/${params.petId}`,
          null,
          {
            params: {
              name: params.name,
  ...
  */
  postPetParamsPetIdUploadImage(
    ...
    params: {
      ...
      return this.getAxios().post(`/pet/${params.petId}/uploadImage`,
          formData,
          {
            params: {
